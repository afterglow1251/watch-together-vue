...
<template>
  ...
  <div class="absolute bottom-[60px] right-3 z-20 flex flex-col items-center gap-1 group select-none">
    <div
      class="flex flex-col gap-1 opacity-0 translate-y-2 pointer-events-none transition-all group-hover:opacity-100 group-hover:translate-y-0 group-hover:pointer-events-auto"
    >
      <button
